...
export class PairVoicePanel {
  public static currentPanel: PairVoicePanel | undefined;
  ...
  private _getHtml(): string {
    ...
    const scriptUri = this._panel.webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, 'media', 'vapi.js')
    );
  ...
  private _fallbackHtml(scriptUri: string, cspSource: string, nonce: string): string {
    return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
